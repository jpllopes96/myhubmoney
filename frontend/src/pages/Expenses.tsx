...
export default function Expenses() {
  ...
  const handleExport = () => {
    ...
    exportTransactionsToExcel(transactions, 'expense');
    toast.success('Arquivo Excel exportado com sucesso!');
  };

  return (
    <PageLayout title="Despesas" subtitle={`Total: ${formattedTotal}`}>
      <div className="space-y-4">
        ...
        <div className="flex gap-3">
          ...
          <Button onClick={() => setFormOpen(true)} className="gradient-expense shrink-0">
